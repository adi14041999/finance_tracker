...
export default function SettingsPanel(props: Props) {
  ...
  // The visible Close button is gone, so the only pointer way out is the
  // backdrop. Escape keeps a keyboard path open — without it this panel would
  // be a trap for anyone not using a mouse.
  useEffect(() => {
    if (!open) return;
